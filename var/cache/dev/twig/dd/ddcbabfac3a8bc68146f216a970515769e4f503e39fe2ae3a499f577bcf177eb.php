...
class __TwigTemplate_ed71fc1b5d5f7463e5da7912397070126e48700e69d23cf3808d71b810080c57 extends Template
{
    private $source;
    private $macros = [];
...
";
        ...
        // line 36
        echo $this->extensions['Knp\Bundle\PaginatorBundle\Twig\Extension\PaginationExtension']->render($this->env, (isset($context["article"]) || array_key_exists("article", $context) ? $context["article"] : (function () { throw new RuntimeError('Variable "article" does not exist.', 36, $this->source); })()));
        echo "
            </div>
        </div> 
    </section> 
    ...
    public function block_article($context, array $blocks = [])
    {
        ...
        echo "       
            ...
            <div class=\"entry__thumb\">
                <img src=\"";
        // line 16
        echo twig_escape_filter($this->env, $this->extensions['Vich\UploaderBundle\Twig\Extension\UploaderExtension']->asset((isset($context["article"]) || array_key_exists("article", $context) ? $context["article"] : (function () { throw new RuntimeError('Variable "article" does not exist.', 16, $this->source); })()), "imageFile"), "html", null, true);
        echo "\" alt=\"\"> 
            </div>
            <div class=\"entry__text\">
                <div class=\"entry__header\">
                    <div class=\"entry__date\">
                        <p>";
        // line 21
        echo twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["article"]) || array_key_exists("article", $context) ? $context["article"] : (function () { throw new RuntimeError('Variable "article" does not exist.', 21, $this->source); })()), "createdAt", [], "any", false, false, false, 21)), "html", null, true);
        echo "<p>                            
                    </div>
                    <h1 class=\"entry__title\"><a href=\"";
        // line 23
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("article", ["slug" => twig_get_attribute($this->env, $this->source, (isset($context["article"]) || array_key_exists("article", $context) ? $context["article"] : (function () { throw new RuntimeError('Variable "article" does not exist.', 23, $this->source); })()), "slug", [], "any", false, false, false, 23)]), "html", null, true);
        echo "\">";
...
";
    ...
    public function block_footer($context, array $blocks = [])
    {
        ...
        // line 42
        echo "    ";
        $this->loadTemplate("/partials/extras.html.twig", "article/index.html.twig", 42)->display($context);
        // line 43
        echo "
";
    ...
    {
        return array (  195 => 43,  192 => 42,  182 => 41,  163 => 26,  155 => 23,  150 => 21,  142 => 16,  128 => 13,  113 => 36,  99 => 35,  97 => 13,  80 => 12,  70 => 4,  60 => 3,  37 => 1,);
    }
...
{% block article %}       
            ...
            <div class=\"entry__text\">
                <div class=\"entry__header\">
                    ...
                    <h1 class=\"entry__title\"><a href=\"{{ path('article', {'slug' : article.slug}) }}\">{{ article.title }}</a></h1>
                </div>
                <div class=\"entry__excerpt\">
...
{% endblock %}
{% block footer %}
    {% include (\"/partials/extras.html.twig\") %}

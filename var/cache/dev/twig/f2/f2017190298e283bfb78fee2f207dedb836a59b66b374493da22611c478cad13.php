...
class __TwigTemplate_c31423f516a7fce45b6afb886593e193700f31c04c4d9804d138b6f544bff782 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        // line 7
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["contactForm"]) || array_key_exists("contactForm", $context) ? $context["contactForm"] : (function () { throw new RuntimeError('Variable "contactForm" does not exist.', 7, $this->source); })()), 'form');
        echo "
";
...
{% block body %}
    ...
    {{ form(contactForm) }}
{% endblock %}
", "contact/index.html.twig", "/home/aurore/Bureau/Rendu/blog_bro/templates/contact/index.html.twig");
    }
}

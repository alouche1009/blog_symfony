...
class __TwigTemplate_be80777febc3f7b1c62d59c394534bdacfedb89f7b76733857e36cf8b381400f extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        // line 7
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["articleForm"]) || array_key_exists("articleForm", $context) ? $context["articleForm"] : (function () { throw new RuntimeError('Variable "articleForm" does not exist.', 7, $this->source); })()), 'form');
        echo "
";
...
{% block body %}
    <h1>Add article</h1>
    {{ form(articleForm) }}
{% endblock %}", "article/add.html.twig", "/home/aurore/Bureau/Rendu/blog_bro/templates/article/add.html.twig");
    }
}

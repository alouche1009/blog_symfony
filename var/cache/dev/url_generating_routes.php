...
return [
    ...
    'article' => [['slug'], ['_controller' => 'App\\Controller\\ArticleController::article'], [], [['variable', '/', '[^/]++', 'slug', true]], [], []],
    'add_article' => [[], ['_controller' => 'App\\Controller\\ArticleController::add'], [], [['text', '/article/add']], [], []],
    ...
    'activation' => [['token'], ['_controller' => 'App\\Controller\\RegistrationController::activation'], [], [['variable', '/', '[^/]++', 'token', true], ['text', '/activation']], [], []],
    ...
    'app_reset_password' => [['token'], ['_controller' => 'App\\Controller\\SecurityController::resetPassword'], [], [['variable', '/', '[^/]++', 'token', true], ['text', '/reset_pass']], [], []],
